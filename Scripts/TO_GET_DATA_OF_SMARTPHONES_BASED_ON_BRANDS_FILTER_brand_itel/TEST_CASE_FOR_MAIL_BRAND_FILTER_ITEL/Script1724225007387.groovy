...
try {
    ...
    String emailBody = "Please find the attached test results from the latest automation run for ital samrtphone from amazon india.\n\n"
    ...
    String filename = "C:\\Users\\DELL\\OneDrive\\Desktop\\mail\\amazon_product_itel_smartphone.xlsx" // Replace with the path to your file
