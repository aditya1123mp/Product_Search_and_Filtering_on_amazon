...
//WebUI.scrollToElement(findTestObject('Object Repository/TO_GET_DATA_OF_SMARTPHONES_BASED_ON_BRANDS_FILTER/to_select_samsung_samrtphone_checkbox'), 2)

WebUI.delay(2)

//WebUI.click(findTestObject('TO_GET_DATA_OF_SMARTPHONES_BASED_ON_BRANDS_FILTER/to_select_samsung_samrtphone_checkbox'))

WebUI.click(findTestObject('Object Repository/TO_GET_DATA_OF_SMARTPHONES_BASED_ON_BRANDS_FILTER/checkbox_for_motorola'))
