...
try {
    ...
    String emailBody = "Please find the attached test results from the latest automation run for motorola samrtphone from amazon india.\n\n"
    ...
    String filename = "C:\\Users\\DELL\\OneDrive\\Desktop\\mail\\amazon_product_motorola_smartphone.xlsx" // Replace with the path to your file
